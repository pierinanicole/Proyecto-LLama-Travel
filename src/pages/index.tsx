...
export default function IcConnectPage(): JSX.Element {
  ...
  <div className="relative z-10">
    {/* Título sin fondo de portada */}
    <div className="llama-travel-bg">
      <h1 className="text-2xl text-center text-white font-serif">LLAMA TRAVEL</h1>
    </div>
  </div>
</main>
        ...
        <div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 py-8">
            <div className="bg-white rounded-lg shadow-md p-6">
              <h2 className="text-xl font-bold mb-2">Informacion del usuario</h2>
              <p className="mt-4 text-sm text-gray-500">
                <strong>Estado:</strong> {isAuthenticated ? "Authenticated" : "Not Authenticated"}
              </p>
              <p className="text-gray-700">
                <strong>ID:</strong> {currentIdentity.getPrincipal().toString()}
              </p>
            </div>
        ...
        <div>
          <h2 className="text-2xl text-center">Reseñas</h2>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 py-8">
            <div className="bg-white rounded-lg shadow-md p-6">
              <h2 className="text-xl font-bold mb-2">Deja tu comentario!!!</h2>
              {!profile ? (
                <ProfileForm
            ...
            <div className="bg-white rounded-lg shadow-md p-6">
              <h2 className="text-xl font-bold mb-2">Nuestras Reseñas</h2>
              {profile ? (
                <>
                  <p className="text-gray-700">
                    <strong>Puntuacion:</strong> {profile?.username}
                  </p>
                  <p className="text-gray-700">
                    <strong>Comentario:</strong> {profile?.bio}
                  </p>
                </>
              ) : (
